    ...
    <body>
        <form action="segurancamvc" method="post">
            <table>
                ...
                <tr>
                    <td>Telefone</td><td><input type="text" maxlength="2" name="telefone"></input></td>
                </tr>
                <tr>
                    <td>Endereco</td><td><input type="text" maxlength="30" name="endereco"></input></td>
                </tr>
                <tr><td align="center" colspan="2"><input type="submit" value="Inserir"></input></td></tr>
                <tr><td><input type="hidden" name="execucao" value="ServletInserir"></input></td></tr>
            </table>
        </form>
    </body>
</html>